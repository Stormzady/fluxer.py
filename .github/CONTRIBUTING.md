...
- [StackOverflow's `fluxer.py` tag](https://stackoverflow.com/questions/tagged/fluxer.py)
...
3. Make sure to provide enough information to make the issue workable. The issue template will generally walk you through the process but they are enumerated here as well:
    ...
    - Tell us **information about your environment**. What version of fluxer.py are you using? How was it installed? What operating system are you running on? These are valuable questions and information that we use.
