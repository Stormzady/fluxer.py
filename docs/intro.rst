...
This is the documentation for fluxer.py, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

fluxer.py works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``fluxer.py[voice]`` instead of ``fluxer.py``, e.g. ::
...
fluxer.py revolves around the concept of :ref:`events <discord-api-events>`.
