...
The following section outlines the API of fluxer.py.
...
fluxer.py offers support for creating, editing, and executing webhooks through the :class:`Webhook` class.
